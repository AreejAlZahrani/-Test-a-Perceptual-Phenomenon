...
There is no need for specific software for this project, but we encourage you to use the Jupyter Notebook workspace in the next section to complete the project using Python.
